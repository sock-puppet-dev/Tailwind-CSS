...
Если ты совсем новичок, сначала прочитай разделы 0-2, затем 4, 6-14 и 21. Разделы 3, 17, 19 и 20 можно считать вторым кругом: они важные, но не должны мешать первому знакомству.
